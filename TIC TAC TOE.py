...
# game window
pg.display.set_caption("Tic Tac Toe by sunil raj")
...
def game_initiating_window():
    ...
    pg.draw.line(screen, line_color, (width / 3, 2), (width / 3, height), 1)
    pg.draw.line(screen, line_color, (width / 3 * 2, 2), (width / 3 * 2, height), 1)

    # drawing horizontal lines
    pg.draw.line(screen, line_color, (2, height / 3), (width, height / 3), 1)
    pg.draw.line(screen, line_color, (2, height / 3 * 2), (width, height / 3 * 2), 1)
    draw_status()
